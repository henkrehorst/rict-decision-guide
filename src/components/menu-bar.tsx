...
import {goToPreviousStep, resetState, selectProgress} from "../redux/guide-slice.ts";
        ...
        <>
            <div className={'absolute top-0 left-0 right-0'}>
                ...
                <div className={'w-full px-6 pt-4 flex justify-between'}>
                    <button onClick={() => {dispatch(goToPreviousStep())}} className={'bg-gray-300 p-2 rounded-3xl hover:bg-gray-200'}>
                        <ArrowLeft size={28} className={'fill-black'}/>
                    </button>
                    <div className={'flex gap-2'}>
                        <button onClick={() => {dispatch(resetState())}} className={'bg-gray-300 p-2 rounded-3xl hover:bg-gray-200'}>
