...
import {
    ...
    ListChecked, NetworkAdminControl,
    ThumbsDown,
    ThumbsUp,
    ToolKit,
    Unknown,
...
export const NonNegotiableQuestionsTable: FC = () => {
    ...
    return (<>
        <table className="table-auto text-left  bg-white border-collapse border border-slate-500 mb-4 w-full">
            <thead>
            <tr className={'border-collapse border border-slate-500'}>
                <th className={'px-4'}>Question</th>
                <th className={'px-4'}>Non Negotiable</th>
                <th className={'px-4'}>Answer</th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr className={'border-collapse border border-slate-500'}>
                ...
                <th className={'px-4 py-2 font-bold'}>{!nonNegotiableTradeResult ?
                    <span
                        className={'text-md text-white bg-green font-inter font-bold text-left w-24 p-2 rounded-xl inline-flex justify-between  items-center'}>
                                        Keep
                                        <Checkmark size={20} className={'fill-current'}/>
